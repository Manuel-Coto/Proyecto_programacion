...
public class VentaDetalleConverter implements Converter<VentaDetalle> {
    ...
    private static final Logger LOGGER = Logger.getLogger(VentaDetalleConverter.class.getName());
    ...
    public VentaDetalle getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
            ...
            VentaDetalle ventaDetalle = ventaDetalleDAO.findById(id);
    ...
    @Override
    public String getAsString(FacesContext context, UIComponent component, VentaDetalle ventaDetalle) {
        ...
        String idString = ventaDetalle.getId().toString();
